...
class Form extends Widget
{
    ...
    protected function addClientValidatingScripts()
    {
        if ($layout = $this->getLayout()) {
            $layout->addHeadCss(new Css('@snowgirl-core/form-validation.min.css'))
                ->addJs(new Js('@snowgirl-core/form-validation.min.js'))
                ->addJs(new Js('@snowgirl-core/form-validation.bootstrap.min.js'));
        }
...
//        $this->countryIso = $countryIso ?: ($this->app->request->getClient()->getCountryIso() ?: $this->app->geo->getClientCountryIso());
        ...
        $node = $this->stringifyContent('@snowgirl-core/widget/form/input/country.phtml');
    ...
    public function getCityInput($countryIso = null, $cityId = null, $isGroup = false)
    {
        ...
        $node = $this->stringifyContent('@snowgirl-core/widget/form/input/city.phtml');
    ...
    public function getPhoneInput($name = null, $countryIso = null, $value = null, $editable = true, $isGroup = false)
    {
        ...
        $this->value = $value;
        $this->editable = !!$editable;
        $node = $this->stringifyContent('@snowgirl-core/widget/form/input/phone.phtml');
...
//                        break;
    ...
    protected function getInner($template = null)
    {
        return implode('', [
            ...
            $this->isValidating() ? $this->stringifyContent('@snowgirl-core/widget/form/validating.phtml') : '',
