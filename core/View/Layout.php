...
abstract class Layout extends View
{
    ...
    {
        parent::__construct($app, '@snowgirl-core/layout.phtml', $params);
    }
...
//        $this->mobileBackBtn = $this->app->request->isWeAreReferer();
    ...
    protected function addCssNodes()
    {
        return $this->addHeadCss(new Css('//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css'))
            ...
            ->addHeadCss(new Css('@snowgirl-core/core.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.grid.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.fonts.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.header.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.toggle.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.nav.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.rounded.css'))
            ->addHeadCss(new Css('@snowgirl-core/core.breadcrumbs.css'))
    ...
    {
        return $this->stringifyContent('@snowgirl-core/layout/head.phtml');
    }
    ...
    protected function makeMessages()
    {
        if ($this->messages = $this->getMessages(true)) {
            return $this->stringifyContent('@snowgirl-core/layout/alerts.phtml');
        }
    ...
    {
        return $this->stringifyContent('@snowgirl-core/layout/bottom.phtml');
    }
