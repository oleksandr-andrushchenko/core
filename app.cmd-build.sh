...
cp ./vendor/snowgirl-core/app.composer.json ./composer.json
...
mkdir web
cp ./vendor/snowgirl-core/app.index.php ./web/index.php
mkdir web/css
...
cp ./vendor/snowgirl-core/app.cmd2.php ./web/cmd
cp ./vendor/snowgirl-core/app.config.ini ./config.ini
echo "" > ./info.txt
